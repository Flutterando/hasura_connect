...
void main() {
  ...
  test('should throw InvalidRequestError if Document is not a mutation', () async {
    ...
    expect(result.fold(id, id), equals(const InvalidRequestError('Document is not a mutation')));
  });
  ...
  test('should throw InvalidRequestError if type request is not mutation', () async {
    ...
    expect(result.fold(id, id), equals(const InvalidRequestError('Request type is not RequestType.mutation')));
  });
