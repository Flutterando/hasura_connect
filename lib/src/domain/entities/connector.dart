...
class Connector extends Stream {
  ...
  int get closeCode => closeCodeFunction();

  Connector(this._webSocketStram,
      {this.add, this.close, this.done, this.closeCodeFunction});

  @override
  StreamSubscription listen(void Function(dynamic event) onData,
      {Function onError, void Function() onDone, bool cancelOnError}) {
    return _webSocketStram.listen(onData,
