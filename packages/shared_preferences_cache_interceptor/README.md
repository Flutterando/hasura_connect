...
<h1 align="center"> Shared Preferences Cache Interceptor</h1>
...
<br></br>
  <p align="center">
    Hasura Connect Cache Interceptor using a <a href="https://pub.dev/packages/shared_preferences">shared_preferences package</a>
    <br />
...
[![License](https://img.shields.io/github/license/Flutterando/hasura_connect?style=plastic)](https://github.com/Flutterando/hasura_connect/blob/master/packages/shared_preferences_cache_interceptor/LICENSE)
...
Hasura Connect Cache Interceptor using the Shared Preferences package.
...
To install Hasura Connect and Shared Preferences Cache Interceptor in your project you can follow the instructions below:
...
b)    or use slidy:
   ```sh
   slidy install hasura_connect, shared_preferences_cache_interceptor
   ```
...
- ✅ Cache Interceptor using Shared Prefences package.
