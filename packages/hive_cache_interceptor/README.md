...
<h1 align="center"> Hive Cache Interceptor</h1>
...
<br></br>
  <p align="center">
    Hasura Connect Cache Interceptor using a <a href="https://pub.dev/packages/hive">hive package</a>
    <br />
...
[![License](https://img.shields.io/github/license/Flutterando/hasura_connect?style=plastic)](https://github.com/Flutterando/hasura_connect/blob/master/packages/hive_cache_interceptor/LICENSE)
...
b)    or use slidy:
   ```sh
   slidy install hasura_connect, hive_cache_interceptor
   ```
